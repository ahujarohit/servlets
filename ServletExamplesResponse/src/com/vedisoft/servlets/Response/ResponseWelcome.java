...
/**
 * Servlet implementation class ResponseWelcome
 */
@WebServlet("/ResponseWelcome")
public class ResponseWelcome extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ResponseWelcome() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<header>");
		out.println("<h1><span>Vedisoft : Response Example 3</span> Welcome Home</h1>");
		out.println("</header>");
