...
public class ShoppingCart extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		out.println("<header>");
		out.println("<h1>Vedisoft : JDBC <span> : Shopping Cart</span></h1>");
		out.println("</header>");
		out.println("<br>");
		out.println("<div  class=\"form\">");
		out.println("<br>");
		out.println("<h1><a href=\"LoginSuccess\">Home</a></h1>");
		out.println("<br>");
		out.println("<table width=\"90%\" border=\"1\">");
		out.println(
				"<tr><td align=\"center\"> Name </td><td align=\"center\"> Price</td><td align=\"center\"> Quantity</td></tr>");
		
		
		if(od == null) {
			out.println("<tr>");
			out.println("<td colspan=\"3\">No Items found in cart</td>");
			out.println("</tr>");
		...
		out.println("</table>");
		out.println("<form id=\"closeShopping\" action=\"/ServletExamplesJdbc/SaveCart\" method=\"post\">");
