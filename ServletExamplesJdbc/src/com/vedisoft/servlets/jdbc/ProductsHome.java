...
public class ProductsHome extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		out.println("}");
		out.println("function mod(productId,productName,productPrice, stockInHand, reorderLevel, categoryId) {");
		out.println("document.getElementById(\"productId\").value = productId;");
		...
		out.println("document.getElementById(\"reorderLevel\").value = reorderLevel;");
		...
		out.println("<header>");
		out.println("<h1>Vedisoft : JDBC <span> : Products Form</span></h1>");
		out.println("</header>");
		...
		out.println("<p class=\"contact\">");
		out.println("<label for=\"reorderLevel\">Reorder Level</label>");
		out.println("</p>");
		out.println(
				"<input id=\"reorderLevel\" name=\"reorderLevel\" placeholder=\"reorderLevel\" required=\"\" tabindex=\"4\" type=\"number\" >");
		...
		out.println(
				"<tr><td align=\"center\"> Name </td><td align=\"center\"> Price</td><td align=\"center\"> Stock In Hand</td><td align=\"center\"> Reorder Level</td><td align=\"center\"> &nbsp;</td><td align=\"center\"> &nbsp;</td></tr>");
		...
		for (Products product : productList) {
			...
			out.println("<td>" + product.getReorderLevel() + "</td>");
			out.println("<td ><input  class=\"buttom\"  name=\"edit\" id=\"edit\" value=\"Edit!\" type=\"button\" "
					...
					+ product.getProductPrice() + "','" + product.getStockInHand() + "','" + product.getReorderLevel()
					+ "','" + product.getCategoryId() + "');\"></td>");
			out.println(
